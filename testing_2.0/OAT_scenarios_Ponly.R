...
if (catchment=='Loxton'){
  ...
  PET = PET[keep]
  Qobs = NULL
} else if (catchment=='Barossa'){
  site.keep = site.min:site.max
...
modelSelection[["penaltyAttributes"]] <- c("P_day_all_tot", "P_day_all_xP99overPave",
                                           "P_day_all_nWet", "P_day_all_avgDSD","P_day_all_seasRatioMarMay")#,
#                                           "PET_day_all_avg","PET_day_all_cor","PET_day_all_cv")
modelSelection[["penaltyWeights"]] = rep(3,5)#8)
...
attsAll = c('P_day_all_avgDSD','P_day_all_tot','P_day_all_xP99overPave','P_day_all_nWet',"P_day_all_seasRatioMarMay")#,
#            "PET_day_all_avg","PET_day_all_cor","PET_day_all_cv")
...
attTied = list(seas=attsAll[attsAll!='P_day_all_seasRatioMarMay'])
