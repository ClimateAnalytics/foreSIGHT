...
sim.stoch.summary = getSimSummary(sim.stoch)
```
...
```{r, virtualObs_fig, fig.align = 'center', dpi = 100, fig.show = "hold", fig.width = 10, fig.height = 10, out.width = "80%", fig.cap = "Evaluation of stochastic climates in terms of capturing hydrological response to observed climates", eval=TRUE}
knitr::include_graphics("plotPerformanceAtts2.png")
```
...
```{r, GR4J_OATplotsSeasRatio_fig, fig.align = 'center', dpi = 100, fig.show = "hold", fig.width = 8, fig.height = 8, out.width = "80%", fig.cap = "Performance for OAT changes in seasonality ratio", eval=TRUE}
...
```{r, GR4J_OATplotsP99_fig, fig.align = 'center', dpi = 100, fig.show = "hold", fig.width = 8, fig.height = 8, out.width = "80%", fig.cap = "Performance for OAT changes in extreme rainfall", eval=TRUE}
...
```{r, GR4J_perfSpace_fig, fig.align = 'center', dpi = 100, fig.show = "hold", fig.width = 10, fig.height = 10, out.width = "47%", fig.cap = "Plots of 2D performance spaces", eval=TRUE}
