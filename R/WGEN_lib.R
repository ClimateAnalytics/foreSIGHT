...
# #-----------------------------------------------------------------------------------------------------------
#
# switch_simulator_OLD = function(type=NULL,          # what vartype is being simulated
#                             parS=NULL,
#                             modelEnv = NULL,
#                             randomTerm=NULL,
#                             wdSeries=NULL,
...
#                                                randomVector = randomTerm$randomVector,) # seed added here for long-term AR1 components (remove later if not required)
#                   },
#                   "wgen" = { P_WGEN_master(parS=parS,              #RAIN SELECTED
#                                   modelEnv = modelEnv$P_modelEnv,
#                                   randomVector = randomTerm$randomVector,
#                                   N=randomTerm$seed)
#
#               # },
#                   # "monAR1" = { simClim_DM(parS=parS,              #RAIN SELECTED
#                   #              modelEnv = modelEnv,
#                   #              randomTerm = randomTerm)
#                   # },
#                   # "distScaling" = { simClim_DM(parS=parS,              #RAIN SELECTED
#                   #                         modelEnv = modelEnv,
#                   #                         randomTerm = NULL,
#                   #                         obs=obs)
#                   # },
#                   # "BLRPM" = { simClim_DM(parS=parS,              #RAIN SELECTED
#                   #                              modelEnv = modelEnv,
#                   #                              randomTerm = randomTerm)
#                   # },
#                   # "LV" = { simClim_DM(parS=parS,              #RAIN SELECTED
#                   #                        modelEnv = modelEnv,
#                   #                        randomTerm = randomTerm)
#                   }, simClim_DM(parS=parS,              #RAIN SELECTED
#                                 modelTag = modelEnv$P_modelEnv$modelTag,
#                                 ppTypes=modelEnv$P_modelEnv$modelInfo$ppTypes,
#                                 datInd=modelEnv$P_modelEnv$datInd,
#                                 randomTerm = randomTerm,
#                                 obs=obs)
#                   )
#          },
...
#                                    seed=seed)
#                   }, simClim_DM(parS=parS,              #RAIN SELECTED
#                                 modelEnv = modelEnv$Temp_modelEnv,
#                                 randomTerm = randomTerm,
#                                 obs=obs)
#            )
#          },
